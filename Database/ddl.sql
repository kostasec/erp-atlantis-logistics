...
CREATE TABLE IncomingInvoice (
	...
	OrderID				INT										
	CONSTRAINT fk_IncomingInvoice_Order 						FOREIGN KEY (OrderID)				REFERENCES WorkOrder (OrderID)
);
GO
...
CREATE TABLE Truck (
    ...
    Status 			NVARCHAR(10) 			NOT NULL
	CONSTRAINT 		ck_Truck_Status			CHECK (Status IN ('Active','Inactive'))
