...
function InvoiceTablePageView({ title, initialInvoices = [], partyKey, partyLabel }) {
  ...
  const filteredInvoices = useMemo(() => {
    ...
    return sortedInvoices.filter(item => {
      ...
      if (search) {
        ...
        const matchesParty = item[partyKey]
          ? item[partyKey].toString().toLowerCase().includes(searchTerm)
          : false;
